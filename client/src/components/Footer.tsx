...
export default function Footer() {
  return (
    <footer className="hth-footer relative z-50 bg-neutral-900 border-t border-white/10 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-100 font-semibold mb-6 max-w-md">
            ...
            <ul className="space-y-2 text-gray-100 font-semibold">
              ...
              <li>
                <Link href="/services#ac" data-testid="footer-link-ac">
                  <span className="hover:text-blue-200 transition-colors">Air Conditioning</span>
                </Link>
              </li>
              <li>
                <Link href="/services#heat-pumps" data-testid="footer-link-heat-pumps">
                  <span className="hover:text-blue-200 transition-colors">Heat Pumps</span>
                </Link>
              </li>
              <li>
                <Link href="/services#water-heaters" data-testid="footer-link-water-heaters">
                  <span className="hover:text-blue-200 transition-colors">Water Heaters</span>
                </Link>
              </li>
              <li>
                <Link href="/services#indoor-air" data-testid="footer-link-indoor-air">
                  <span className="hover:text-blue-200 transition-colors">Indoor Air Quality</span>
                </Link>
              </li>
              <li>
                <Link href="/services#radiant" data-testid="footer-link-radiant">
                  <span className="hover:text-blue-200 transition-colors">Radiant Heating</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-blue-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-100 font-semibold text-sm" data-testid="footer-copyright">
            © 2024 Hometown Heating Inc. All rights reserved.
          </div>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" data-testid="footer-link-privacy">
              <span className="text-gray-100 font-semibold text-sm hover:text-blue-200 transition-colors">
                Privacy Policy
              </span>
            </Link>
